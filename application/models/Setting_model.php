...
class Setting_model extends MY_Model {
    ...
    public function getCurrentSessionText() {
        $session_result = $this->get();
       
        return $session_result[0]['session_text'];
    }
